...
$$ \left\Vert C^{tr}_i - C^{gt}_i \right\Vert _2 = \left\Vert \begin{pmatrix} C^{tr}_{x,i} \\ 
C^{tr}_{y,i} 
\end{pmatrix} - 
\begin{pmatrix} C^{gt}_{x,i} \\ 
C^{gt}_{y,i} 
\end{pmatrix} \right\Vert _2 = \left\Vert \begin{pmatrix} C^{tr}_{x,i} - C^{gt}_{x,i} \\ 
C^{tr}_{y,i} - C^{gt}_{y,i} 
...
$$\Vert W_i^{-1} \left( C^{tr}_i - C^{gt}_i \right) \Vert_2 = \left\Vert \begin{pmatrix} \frac {1} {BB_{x,i}^{gt}} & 0 \\ 
0 & \frac {1} {BB_{y,i}^{gt}} 
\end{pmatrix} \begin{pmatrix} C^{tr}_{x,i} - C^{gt}_{x,i} \\ 
C^{tr}_{y,i} - C^{gt}_{y,i} 
\end{pmatrix} \right\Vert _2$$
