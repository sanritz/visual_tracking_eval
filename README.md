...
$$ P =\left\| C^{tr} - C^{gt} \right\| _2 = \left\| \begin{pmatrix} C^{tr}_x \\ 
C^{tr}_y 
\end{pmatrix} - 
\begin{pmatrix} C^{gt}_x \\ 
C^{gt}_y 
\end{pmatrix} \right\| _2 = \left\| \begin{pmatrix} C^{tr}_x - C^{gt}_x \\ 
C^{tr}_y - C^{gt}_y 
...
$$ P_{norm} = \left\| \begin{pmatrix} BB_x^{gt} & 0 \\ 
0 & BB_y^{gt} 
\end{pmatrix} \begin{pmatrix} C^{tr}_x - C^{gt}_x \\ C^{tr}_y - C^{gt}_y \end{pmatrix} \right\|_2$$
